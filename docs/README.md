...
> Owner: kv (index) · Status: [~] current · Last updated: 2026-09-05
>
...
| [design/design-hr-signal-engine.md](architecture/design/design-hr-signal-engine.md) | kv | [~] | Ingestion pipeline engineering design |
| [design/design-risk-engine.md](architecture/design/design-risk-engine.md) | kv | [~] | Rules engine engineering design |
...
|---|---|---|---|
| [F01-hr-signal-engine.md](features/F01-hr-signal-engine.md) | kv | [~] | FR-01, FR-08 |
...
| [F04-risk-rules-engine.md](features/F04-risk-rules-engine.md) | kv | [~] | FR-05, FR-06, FR-07 |
| [F05-intervention-engine.md](features/F05-intervention-engine.md) | kv | [~] | FR-09, FR-10, FR-11, FR-13 |
...
| [F08-privacy-safety-architecture.md](features/F08-privacy-safety-architecture.md) | kv | [~] | FR-14, FR-16, FR-17, FR-18, NFR-01/02/08 |
...
| Doc | Owner | Status | One line |
|---|---|---|---|
| [dpdp-2023-mapping.md](compliance/dpdp-2023-mapping.md) | kv | [~] | DPDP Act 2023 obligation → mechanism map |
| [mental-healthcare-act-2017.md](compliance/mental-healthcare-act-2017.md) | kv | [~] | §23 confidentiality + non-discrimination |
...
| Doc | Owner | Status | One line |
|---|---|---|---|
| [model-explainer.md](explanation/model-explainer.md) | kv | [~] | Rules v1 → ML v2, SHAP, fairness |
...
| [demo-runbook.md](quality/demo-runbook.md) | kv | [~] | 3-min script, seeded data, fallbacks |
