# Compliance Sources Pack — exact statute text

> Owner: manan · Status: [x] filled (PRIV-005) · Last updated: 2026-09-08
> Junior-owned file. Each block below is **quoted text**, not a paraphrase. kv reviews before merge.
>
> **Not legal advice.** Engineering compliance notes for SAARTHI (SIH 2026, PS 26186). India's law is the **Digital Personal Data Protection Act, 2023** — never "PDPA".

## How this pack was filled

1. Named the official locator for each Act (Gazette + India Code + MeitY).
2. Copied the section text from a secondary locator that reproduces the Gazette lettering `(a)–(i)`.
3. Recorded the URL and the date accessed.
4. Where the official PDF/HTML host returned `Access Denied` from this machine, that is written in the source line — not guessed around.

**Re-verify against the Gazette PDF before any formal legal review.** MeitY and India Code were Akamai-blocked from this environment on 2026-09-08. Secondary hosts (CADP, courtbook, Indian Kanoon) are locators, not the statute.

## DPDP Act 2023

**Official citation:** The Digital Personal Data Protection Act, 2023 (Act No. 22 of 2023). Gazette of India, Extraordinary, Part II, Section 1, 11 August 2023 / Sravana 20, 1945 (Saka). Presidential assent 11 August 2023.

| Locator | URL | Accessed | Result |
|---|---|---|---|
| India Code (official) | https://www.indiacode.nic.in/handle/123456789/22412 | 2026-09-08 | `Access Denied` (Akamai EdgeSuite) |
| India Code bitstream | https://www.indiacode.nic.in/bitstream/123456789/22412/1/a2023-22.pdf | 2026-09-08 | `Access Denied` |
| MeitY PDF | https://www.meity.gov.in/static/uploads/2024/01/Digital-Personal-Data-Protection-Act-2023.pdf | 2026-09-08 | `Access Denied` |
| MeitY Act and Policies index | https://www.meity.gov.in/documents/act-and-policies?page=2 — row "Digital Personal Data Protection Act 2023", published 11.08.2023 | 2026-09-08 | index listed; PDF behind the same block |
| CADP interactive text | https://cadp.in/resources/official-texts/dpdp-act-2023/ | 2026-09-08 | full Act; numbered `(a)–(i)` as `1.–9.` |
| courtbook bare Act | https://courtbook.in/bare-acts/digital-personal-data-protection-act-2023 | 2026-09-08 | full Act; Gazette lettering `(a)–(i)` preserved |
| Indian Kanoon §7 | https://indiankanoon.org/doc/62814281/ | 2026-09-08 | §7 including clause (i) |

Quotes below follow courtbook lettering (matches the Gazette). CADP is the same words with clauses numbered instead of lettered. Illustrations are part of the Act and are quoted with the section.

### Section 7(i) — legitimate uses (employment)

Source: Gazette / India Code handle above; verified 2026-09-08 against courtbook §7 and Indian Kanoon `doc/62814281`.
Accessed: 2026-09-08

The chapeau of section 7, then clause (i):
...
Full section 7 (clauses (a)–(i)), so (i) is not quoted out of context:
...
Illustrations under clauses (a) and (b) are in the Act; they are omitted here to keep the pack short. They are on the courtbook and CADP pages above.

### Sections 4–6 — consent, notice, withdrawal

Source: same official locators; verified 2026-09-08 against courtbook §§4–6 and CADP.
Accessed: 2026-09-08

The PRIV-005 board row names “§4–5”. The sources template also asks for withdrawal, which is **section 6**. All three are quoted.
...
Illustration under §5(1) (bank KYC video identification) and under §5(2) (pre-commencement e-commerce consent) are on the courtbook / CADP pages.

#### Section 6 — Consent (including withdrawal)
...
Illustrations under §6(1) (telemedicine vs phone contacts), §6(2) (invalid waiver of Board complaint), §6(5) (paid order still fulfilled after withdrawal) and §6(6) (processor must cease emailing bills) are on the courtbook / CADP pages.

## Mental Healthcare Act 2017

**Official citation:** The Mental Healthcare Act, 2017 (Act No. 10 of 2017). Gazette of India, Extraordinary, Part II, Section 1, 7 April 2017. Presidential assent 7 April 2017.

| Locator | URL | Accessed | Result |
|---|---|---|---|
| India Code (official) | https://www.indiacode.nic.in/handle/123456789/8814 | 2026-09-08 | `Access Denied` (Akamai EdgeSuite) |
| Indian Kanoon entire Act | https://indiankanoon.org/doc/14507371/ | 2026-09-08 | full Act; §23 is two subsections only |
| Indian Kanoon §23 | https://indiankanoon.org/doc/110040215/ | 2026-09-08 | §23(1)–(2)(a)–(g) |
| Indian Kanoon §23(1) | https://indiankanoon.org/doc/43332179/ | 2026-09-08 | subsection (1) |
| Indian Kanoon §23(2) | https://indiankanoon.org/doc/109046697/ | 2026-09-08 | subsection (2)(a)–(g) |
| courtbook §23 | https://courtbook.in/search/section/section-23-right-to-confidentiality-66829fd728263b967f09caa2 | 2026-09-08 | same text |
| Goa Gazette republication (scan) | https://www.goa.gov.in/wp-content/uploads/2022/12/Mental-Health-Act-2017.pdf | 2026-09-08 | PDF 310,661 bytes; two-column scan, OCR garbled — not used as quote source |

### Section 23 — right to confidentiality

Source: Gazette / India Code handle above; verified 2026-09-08 against Indian Kanoon `doc/110040215` and courtbook.
Accessed: 2026-09-08
...
**There is no section 23(3).** The Act’s next section is 24. kv’s mapping file currently cites a “§23(3)” confidentiality-guidelines duty — that number is not in this Act. Flagged in `executable/manan/notes.md` for kv. Do not quote a non-existent subsection.

### Adjacent (not the PRIV-005 ask) — Section 24(2), electronic / digital confidentiality

Quoted only so the deck and mapping can point at the digital-records sentence without inventing a §23(3).
...
Source: Indian Kanoon entire Act `doc/14507371`, Chapter V, accessed 2026-09-08.

## One-liners for the privacy slide (risa: copy from here only)

Pick **one** of these. Do not rewrite them.

1. DPDP 2023 §7(i): “for the purposes of employment or those related to safeguarding the employer from loss or liability, such as prevention of corporate espionage, maintenance of confidentiality of trade secrets, intellectual property, classified information or provision of any service or benefit sought by a Data Principal who is an employee.”
2. DPDP 2023 §6(4): “Where consent given by the Data Principal is the basis of processing of personal data, such Data Principal shall have the right to withdraw her consent at any time, with the ease of doing so being comparable to the ease with which such consent was given.”
3. MHCA 2017 §23(1): “A person with mental illness shall have the right to confidentiality in respect of his mental health, mental healthcare, treatment and physical healthcare.”

## How this pack is used

- [dpdp-2023-mapping.md](dpdp-2023-mapping.md) and [mental-healthcare-act-2017.md](mental-healthcare-act-2017.md) cite these sections — this file is their verbatim evidence.
- The deck's privacy slide quotes one line from here (risa pulls it from this file only).
- Walkthrough against the running API is in [executable/manan/notes.md](../../executable/manan/notes.md) (PRIV-006).
