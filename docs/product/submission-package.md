...
Privacy basis: DPDP 2023 §7(i)/§7(d) legitimate use for HR signals; explicit unbundled consent for voluntary data; Mental Healthcare Act 2017 §23 as the confidentiality floor. On-prem / NIC MeghRaj deployable; no foreign SaaS touches welfare data.

## Presentation PDF

Built by risa in the official SIH template ([deck-outline.md](../deck/deck-outline.md), [ppt-guide.md](../deck/ppt-guide.md)). Until DECK-001 lands, do **not** upload a substitute deck. This file is the title + description lock.

## Package checklist (kv, T-minus-24h)

- [ ] Title + description pasted into the portal (this file).
- [ ] Deck PDF (DECK-001) attached.
- [ ] Team name, 6 members, authorization letter (principal-signed).
- [ ] GitHub repo URL (this repo) in the description or deck.
- [ ] No invented statistics on any slide (AGENTS rule 7).
- [ ] One cited statistic only: ThePrint 654 suicides / ~50,000 resignations in 5 years — said once, cited verbally.
